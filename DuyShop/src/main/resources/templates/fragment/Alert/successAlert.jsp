...
<c:if test="${messengeSuccess != null}">
    ...
    <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
        ...
        <div class="swal2-actions">
            <a href="${linkSuccess}">
                <button type="button" onclick="closeAlertSuccess3()" class="swal2-confirm swal2-styled" aria-label=""
...
<script>
    setTimeout(closeAlertSuccess3, 1000)

    function closeAlertSuccess3() {
